...
assert.match(html, /<button id="inputButton"[^>]*>入力<\/button>/);
assert.match(html, /<button id="outputButton"[^>]*>出力<\/button>/);
assert.match(html, /id="dataFileInput"/);
assert.match(html, /async function ensureSheetJS/);
assert.match(html, /function buildZip/);
assert.match(html, /function buildExportScriptText/);
